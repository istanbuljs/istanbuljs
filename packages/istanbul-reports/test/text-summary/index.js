...
const TextSummaryReport = require('../../lib/text-summary/index');

require('chai').should();

describe('TextSummaryReport', () => {
    before(() => {
    ...
    function createTest(file) {
        ...
        it(fixture.title, function() {
            ...
            const report = new TextSummaryReport(fixture.opts);
            tree.visit(report, context);
            const output = FileWriter.getOutput();
            output.should.equal(fixture.textSummaryReportExpected);
        });
    }
